...
enum CostUsageScanner {
        ...
        options: Options = Options()) -> CostUsageDailyReport
    {
        ...
        case .zai, .gemini, .antigravity, .cursor, .opencode, .opencodego, .alibaba, .factory, .copilot,
             ...
             .kimik2, .augment, .jetbrains, .amp, .ollama, .synthetic, .openrouter, .warp, .perplexity, .doubao,
             .abacus, .mistral, .deepseek, .codebuff, .crof, .windsurf, .venice, .commandcode, .stepfun:
            return emptyReport
        }
    }
