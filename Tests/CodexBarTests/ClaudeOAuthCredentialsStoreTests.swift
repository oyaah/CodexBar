...
struct ClaudeOAuthCredentialsStoreTests {
    ...
    @Test
    func loadsFromKeychainCacheBeforeExpiredFile() async throws {
    ...
    @Test
    func invalidatesCacheWhenCredentialsFileChanges() async throws {
        KeychainCacheStore.setTestStoreForTesting(true)
        defer { KeychainCacheStore.setTestStoreForTesting(false) }
    ...
    @Test
    func returnsExpiredFileWhenNoOtherSources() async throws {
        try await KeychainAccessGate.withTaskOverrideForTesting(true) {
            KeychainCacheStore.setTestStoreForTesting(true)
            defer { KeychainCacheStore.setTestStoreForTesting(false) }
    ...
    @Test
    func loadRecord_legacyCacheEntryWithoutOwner_defaultsToClaudeCLIOwner() async throws {
        KeychainCacheStore.setTestStoreForTesting(true)
        defer { KeychainCacheStore.setTestStoreForTesting(false) }
    ...
    @Test
    func hasCachedCredentials_returnsFalseForExpiredUnrefreshableCodexbarCacheEntry() async throws {
        KeychainCacheStore.setTestStoreForTesting(true)
        defer { KeychainCacheStore.setTestStoreForTesting(false) }
    ...
    @Test
    func hasCachedCredentials_returnsTrueForExpiredRefreshableCacheEntry() async throws {
        KeychainCacheStore.setTestStoreForTesting(true)
        defer { KeychainCacheStore.setTestStoreForTesting(false) }
    ...
    @Test
    func hasCachedCredentials_returnsTrueForExpiredClaudeCLIBackedCredentialsFile() async throws {
        KeychainCacheStore.setTestStoreForTesting(true)
        defer { KeychainCacheStore.setTestStoreForTesting(false) }
    ...
    @Test
    func syncsCacheWhenClaudeKeychainFingerprintChangesAndTokenDiffers() async throws {
        let service = "com.steipete.codexbar.cache.tests.\(UUID().uuidString)"
        try await KeychainCacheStore.withServiceOverrideForTesting(service) {
    ...
    @Test
    func respectsPromptCooldownGateWhenDisabledPrompting() async throws {
        let service = "com.steipete.codexbar.cache.tests.\(UUID().uuidString)"
        try await KeychainCacheStore.withServiceOverrideForTesting(service) {
            KeychainCacheStore.setTestStoreForTesting(true)
            defer { KeychainCacheStore.setTestStoreForTesting(false) }
    ...
    @Test
    func doesNotShowPreAlertWhenClaudeKeychainReadableWithoutInteraction() async throws {
        KeychainCacheStore.setTestStoreForTesting(true)
        defer { KeychainCacheStore.setTestStoreForTesting(false) }
    ...
    @Test
    func showsPreAlertWhenClaudeKeychainLikelyRequiresInteraction() async throws {
        KeychainCacheStore.setTestStoreForTesting(true)
        defer { KeychainCacheStore.setTestStoreForTesting(false) }
    ...
    @Test
    func showsPreAlertWhenClaudeKeychainPreflightFails() async throws {
        KeychainCacheStore.setTestStoreForTesting(true)
        defer { KeychainCacheStore.setTestStoreForTesting(false) }
