...
struct SettingsStoreTests {
    ...
    @Test
    func reconcileMergedOverviewSelectionKeepsStoredPreferenceWhenThreeOrFewer() throws {
    ...
    @Test
    func reconcileMergedOverviewSelectionDoesNotRewriteSubsetWhenThreeOrFewer() throws {
