...
### Fixes
- Cost history: keep manual refreshes on the incremental scanner cache so large Codex/Claude histories do not trigger full local log rescans and CPU/memory spikes.
