...
## Quotio/Views/Screens/SettingsScreen.swift (2747 lines)
...
| 880 | struct | RefreshCadenceSettingsSection | (internal) |
| 919 | struct | UpdateSettingsSection | (internal) |
| 961 | struct | ProxyUpdateSettingsSection | (internal) |
| 1091 | fn | checkForUpdate | (private) |
| 1101 | fn | performUpgrade | (private) |
| 1120 | struct | ProxyVersionManagerSheet | (internal) |
| 1279 | fn | sectionHeader | (private) |
| 1294 | fn | isVersionInstalled | (private) |
| 1298 | fn | refreshInstalledVersions | (private) |
| 1302 | fn | loadReleases | (private) |
| 1316 | fn | installVersion | (private) |
| 1334 | fn | performInstall | (private) |
| 1355 | fn | activateVersion | (private) |
| 1373 | fn | deleteVersion | (private) |
| 1386 | struct | InstalledVersionRow | (private) |
| 1444 | struct | AvailableVersionRow | (private) |
| 1530 | fn | formatDate | (private) |
| 1548 | struct | MenuBarSettingsSection | (internal) |
| 1630 | struct | AppearanceSettingsSection | (internal) |
| 1659 | struct | PrivacySettingsSection | (internal) |
| 1681 | struct | GeneralSettingsTab | (internal) |
| 1720 | struct | AboutTab | (internal) |
| 1747 | struct | AboutScreen | (internal) |
| 1962 | struct | AboutUpdateSection | (internal) |
| 2018 | struct | AboutProxyUpdateSection | (internal) |
| 2154 | fn | checkForUpdate | (private) |
| 2164 | fn | performUpgrade | (private) |
| 2183 | struct | VersionBadge | (internal) |
| 2235 | struct | AboutUpdateCard | (internal) |
| 2326 | struct | AboutProxyUpdateCard | (internal) |
| 2483 | fn | checkForUpdate | (private) |
| 2493 | fn | performUpgrade | (private) |
| 2512 | struct | LinkCard | (internal) |
| 2599 | struct | ManagementKeyRow | (internal) |
| 2693 | struct | LaunchAtLoginToggle | (internal) |
