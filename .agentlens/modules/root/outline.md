...
## Quotio/Services/AgentConfigurationService.swift (675 lines)
...
| 611 | fn | testConnection | (internal) |
...
## Quotio/Services/StatusBarMenuBuilder.swift (883 lines)
...
| 285 | fn | quit | (internal) |
| 295 | struct | MenuHeaderView | (private) |
| 318 | struct | MenuProxyInfoView | (private) |
| 377 | struct | MenuProviderPickerView | (private) |
| 412 | struct | ProviderFilterButton | (private) |
| 437 | struct | ProviderIconMono | (private) |
| 461 | struct | MenuAccountCardView | (private) |
| 659 | struct | AntigravityDisplayGroup | (private) |
| 668 | struct | ModelBadgeData | (private) |
| 675 | struct | ModelGridBadge | (private) |
| 719 | struct | MenuModelDetailView | (private) |
| 771 | struct | MenuEmptyStateView | (private) |
| 786 | mod | extension AIProvider | (private) |
| 807 | struct | MenuActionsView | (private) |
| 848 | struct | MenuBarActionButton | (private) |
